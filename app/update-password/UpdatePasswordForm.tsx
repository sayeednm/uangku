...
export default function UpdatePasswordForm() {
  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit} action="/auth/update-password" method="post" className="space-y-4" noValidate>
      {errorMsg && (
      ...
      <div>
        ...
        <div className="relative">
          <input id="password" name="password" type={showPassword ? 'text' : 'password'}
            required disabled={isLoading} autoFocus autoComplete="new-password"
